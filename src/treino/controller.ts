...
export class TreinoController {
  ...
  // Permite criar templates (Profissional/Admin) ou treinos customizados (qualquer usuário).
  @Post()
  ...
  // Apenas quem criou (e Admin) pode editar.
  @Put(':id')
  @UseGuards(AuthGuard('jwt')) 
  ...
  // --- 3. ENDPOINTS DE GERENCIAMENTO DE ITENS E FLUXO ---
